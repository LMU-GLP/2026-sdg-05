...
5. GitHub asks whether Claude can access your account. Press the green
   **Authorize** button
6. Back in the repo list, search for `2026-sdg-05` and click
   **LMU-GLP/2026-sdg-05**

**Repo not in the list?** You haven't accepted the invitation to it yet. Open
**[github.com/LMU-GLP/2026-sdg-05/invitations](https://github.com/LMU-GLP/2026-sdg-05/invitations)**
...
[github.com/LMU-GLP/2026-sdg-05](https://github.com/LMU-GLP/2026-sdg-05).
...
```
Set up this repo as an LLM wiki for our challenge: "How might we empower girls to feel confident, supported, and able to lead in their community?"
...
https://sdgs.un.org/goals/goal5, one dataset with real figures, and one
...
[your repo](https://github.com/LMU-GLP/2026-sdg-05) and click the
**Pull requests** tab.
...
**[github.com/LMU-GLP/2026-sdg-05/tree/main/wiki](https://github.com/LMU-GLP/2026-sdg-05/tree/main/wiki)**
...
**https://lmu-glp.github.io/2026-sdg-05/**
...
[your repo](https://github.com/LMU-GLP/2026-sdg-05) → **Pull requests** tab.
